...
class LocalRepositoryImpl implements LocalRepository {
  ...
  Future<void> updateTokenData(UserModel user) async {
    ...
    await _storage.write(
      SecureStorageKeys.kExpiresIn,
      user.expiresIn.toString(),
    );
  }
  ...
  Future<void> updateRefreshTokenData({
    ...
    await _storage.write(SecureStorageKeys.kIsLogin, true.toString());
    await _storage.write(SecureStorageKeys.kToken, accessToken);
    await _storage.write(SecureStorageKeys.kRefreshToken, refreshToken);
    await _storage.write(SecureStorageKeys.kTokenType, tokenType);
    await _storage.write(SecureStorageKeys.kExpiresIn, expiresIn);
  }
}
