import 'package:core/domain/repositories/eshop_repository.dart' show EshopRepository;
...
class EshopRepositoryImpl implements EshopRepository {
  ...
  @override
  Future<Either<String, CommonResponse<CategoryResponse>>> getStoreTypes(Map<String, dynamic> params) async {
    try {
  ...
  @override
  Future<Either<String, CommonResponse<EshopHomeResponse>>> getEshopHome(Map<String, dynamic> params) async {
    try {
  ...
  @override
  Future<Either<String, CommonResponse<ProductListResponse>>> getProductList(Map<String, dynamic> params) async {
    try {
  ...
  @override
  Future<Either<String, CommonResponse<CatProductListResponse>>> getCatAndProductList(Map<String, dynamic> params) async {
    try {
  ...
  @override
  Future<Either<String, CommonResponse<ProductDetailsResponse>>> getProductDetails(Map<String, dynamic> params) async {
    try {
  ...
  @override
  Future<Either<String, CommonResponse<ProductListResponse>>> getSimilarProducts(Map<String, dynamic> params) async {
    try {
  ...
  @override
  Future<Either<String, CommonResponse<List<WishlistResponse>>>> getWishList(Map<String, dynamic> params) async {
    try {
  ...
  @override
  Future<Either<String, CommonResponse<dynamic>>> toggleWishlist(Map<String, dynamic> params) async {
    try {
  ...
  @override
  Future<Either<String, CommonResponse<List<DealsResponseModel>>>> getDeals() async {
    try {
      final response = await apiService.getDeals();
      return Right(response);
    } on DioException catch (dioError) {
      return Left(dioError.message ?? 'An error occurred');
    } catch (e) {
  ...
  @override
  Future<Either<String, CommonResponse<DealsResponseModel>>> getDealProductList(int dealId, Map<String, dynamic> params) async {
    try {
      final response = await apiService.getDealProductList(dealId, params);
      return Right(response);
    } on DioException catch (dioError) {
      return Left(dioError.message ?? 'An error occurred');
    } catch (e) {
  ...
  @override
  Future<Either<String, CommonResponse<List<ReturnReasonsResponse>>>> getReturnReasons() async {
    try {
      final response = await apiService.getReturnReasons();
      return Right(response);
    } on DioException catch (dioError) {
      return Left(dioError.message ?? 'An error occurred');
    } catch (e) {
