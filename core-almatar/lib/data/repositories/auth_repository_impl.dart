...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<Either<String, InitResponse>> getInit(String appType, String appVersion) async {
    try {
      final posts = await apiService.getInit(Config.apiUrl, appType, appVersion);
      return Right(posts);
  ...
  @override
  Future<Either<String, CommonResponse<dynamic>>> sendOtp(Map<String, dynamic> params) async {
    try {
  ...
  @override
  Future<Either<String, CommonResponse>> doDeleteAccount() async {
    try {
      final posts = await apiService.doDeleteAccount();
      return Right(posts);
    } on DioException catch (dioError) {
      // Interceptor already parsed the error message
      return Left(dioError.message ?? 'An error occurred');
  ...
  @override
  Future<Either<String, CommonResponse>> doLogout(Map<String, String> params) async {
    try {
      final posts = await apiService.doLogout(params);
      return Right(posts);
    } on DioException catch (dioError) {
      // Interceptor already parsed the error message
      return Left(dioError.message ?? 'An error occurred');
  ...
  @override
  Future<Either<String, CommonResponse<RefreshTokenResponse>>> refreshToken(Map<String, String> params) async {
    try {
  ...
  @override
  Future<Either<String, CommonResponse<ReferralProgressModel>>> referralMessage() async {
    try {
      final posts = await apiService.referralMessage();
      return Right(posts);
    } on DioException catch (dioError) {
      // Interceptor already parsed the error message
      return Left(dioError.message ?? 'An error occurred');
  ...
  @override
  Future<Either<String, CommonResponse<CartCountModel>>> getCartCount(Map<String, dynamic> params) async {
    try {
      final posts = await apiService.getCartCount(params);
      return Right(posts);
    } on DioException catch (dioError) {
      // Interceptor already parsed the error message
      return Left(dioError.message ?? 'An error occurred');
