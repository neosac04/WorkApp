...
class CommonComponents {
  ...
  static Future<DateTime?> showCommonDatePicker({
    ...
    return await showDatePicker(
      ...
      errorFormatText: context.lt.please_enter_date,
      builder: (context, child) {
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: ColorScheme.light(primary: Theme.of(context).primaryColor, onSurface: ColorConstants.themeTextColor),
          ),
          child: child!,
        );
      },
