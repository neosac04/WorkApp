...
Widget getNetworkImageViewAPI(
  ...
  if (isGif) {
    ...
    // 🔹 Apply color filter safely
    final Widget filteredGifImage = colorFilter != null
        ? ColorFiltered(colorFilter: colorFilter!, child: gifImage)
        : gifImage;
...
Widget _errorWidget(
  ...
  return SizedBox(
    ...
    height: height,
    child: Center(
      child: SvgGenImage(Assets.icons.icAppLogo.path).svg(
