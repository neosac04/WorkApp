...
class SingleRadioSelector<T> extends StatelessWidget {
  ...
  crossAxisAlignment; // For vertical alignment in horizontal mode
  ...
  ///radio button text clickable or not
          ...
          children: [
            SizedBox(
              ...
              child: Radio<int>(
                ...
                visualDensity: compactDesign
                    ? VisualDensity.compact
                    : VisualDensity.standard,
                materialTapTargetSize: compactDesign
            ...
            direction == Axis.horizontal
                ? Text(
                    ...
                    onTap: (clickable && isTextClickable)
                        ? () {
                            onIndexChanged(index, options[index]);
                          }
                        : null,
                  )
                : Expanded(
        ...
        return Column(
          ...
          children: radioItems.asMap().entries.map((entry) {
            ...
            return Column(
              children: [
                item,
                if (index < radioItems.length - 1) verticalGap.vBox(context),
              ],
            );
          }).toList(),
        );
