...
final tappedItemProvider = NotifierProvider<TappedItemNotifier, Object?>(
  TappedItemNotifier.new,
);

// 2. Define the Notifier class
class TappedItemNotifier extends Notifier<Object?> {
  @override
  Object? build() => null; // Initial state
