...
class AddressSelectionBottomSheet extends StatelessWidget {
  ...
  final Widget Function(dynamic address, bool isSelected, VoidCallback onTap) addressCardBuilder;
      ...
      children: [
        ...
        Flexible(
          child: ListView.separated(
            ...
            separatorBuilder: (context, index) => AppSizeConstants.size_10.vBox(context),
  ...
  static Future<void> show({
    ...
    required Widget Function(dynamic address, bool isSelected, VoidCallback onTap) addressCardBuilder,
