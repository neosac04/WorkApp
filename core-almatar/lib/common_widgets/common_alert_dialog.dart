  ...
  showDialog(
    ...
    builder: (_) => PopScope(
      ...
      child: Dialog(
        ...
        shape: RoundedRectangleBorder(borderRadius: context.scaledCircularBorderRadius(20)),
        ...
        child: Stack(
          ...
          children: [
            Padding(
              padding: context.scaledUniformDirectionalPadding(AppSizeConstants.size_20).copyWith(top: 60),
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  if (iconTopPosition > 0) ...[12.vBox(context)],

                  /// Title
                  Text(title, softWrap: false, style: titleStyle ?? context.textTheme.headlineSmall, textAlign: TextAlign.center),
                  12.vBox(context),
                  ...
                  Text(
                    ...
                    style: subtitleStyle ?? context.textTheme.labelMedium?.copyWith(color: ColorConstants.darkGrayColor),
                  ...
                  CommonButton(
                    ...
                    textStyle: context.textTheme.titleSmall?.copyWith(color: Colors.white, fontWeight: FontWeight.w600),
                  ...
                  if (showCancelButton) ...[
                    ...
                    CommonButton(
                      ...
                      backgroundColor: Colors.white,
                      textStyle: context.textTheme.titleSmall?.copyWith(color: ColorConstants.grayColor6),
                      showBorder: false,
              ...
              child: Center(
                child: Container(
                  decoration: BoxDecoration(
                    boxShadow: isShadow ? [BoxShadow(color: Colors.black.withOpacity(0.15), blurRadius: 8, offset: const Offset(0, 4))] : [],
                  ),
                  child: topWidget,
                ),
              ),
...
void showLoginDialog({required BuildContext context}) {
  showConfirmationDialog(
    ...
    topWidget: Transform.flip(
      flipX: true,
      child: SvgGenImage(Assets.icons.icLogoutDialogIcon.path).svg(height: 65.scaled(context), width: 65.scaled(context), matchTextDirection: true),
    ),
    onConfirm: () {
