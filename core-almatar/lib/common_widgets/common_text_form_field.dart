...
class CommonTextFormField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final OutlineInputBorder noBorder = const OutlineInputBorder(
    ...
    return TextFormField(
      ...
      selectionControls: Platform.isIOS ? null : null,
      ...
      decoration: InputDecoration(
        ...
        hintStyle: Theme.of(
          context,
        ).textTheme.bodyMedium?.copyWith(color: ColorConstants.darkGrayColor),
        labelText: labelText,
        prefixIconConstraints: BoxConstraints(
          minWidth: AppSizeConstants.size_30.scaled(context),
        ),
        prefixIcon: enablePrefixPadding
            ? prefixIcon?.paddingDirectionalOnly(
                context,
                start: AppSizeConstants.size_12,
                end: AppSizeConstants.size_4,
              )
            : prefixIcon,
        suffixIcon: enableSuffixPadding
            ? suffixIcon?.paddingDirectionalOnly(
                context,
                start: AppSizeConstants.size_4,
                end: AppSizeConstants.size_12,
              )
            : suffixIcon,
        border: isBorderDisabled
            ? noBorder
            : OutlineInputBorder(
                borderRadius: context.scaledCircularBorderRadius(borderRadius),
                borderSide: BorderSide(color: borderColor),
              ),
        enabledBorder: isBorderDisabled
            ? noBorder
            : OutlineInputBorder(
        ...
        focusedBorder: isBorderDisabled
            ? noBorder
            : OutlineInputBorder(
                borderRadius: context.scaledCircularBorderRadius(
                  focusedBorderRadius,
