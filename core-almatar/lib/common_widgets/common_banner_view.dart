          ...
          children: List.generate(
            ...
            (indicatorIndex) => AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: _currentPage == indicatorIndex ? Theme.of(context).primaryColor : ColorConstants.themeColor3,
