...
class DashedBorderButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CommonButton(
      ...
      backgroundColor: Theme.of(context).scaffoldBackgroundColor.withAlpha((0.3 * 255).toInt()),
      borderColor: Theme.of(context).colorScheme.secondary.withAlpha((0.6 * 255).toInt()),
