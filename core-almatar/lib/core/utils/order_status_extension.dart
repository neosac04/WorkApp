...
extension OrderStatusIntExtension on int {
  OrderStatusEnum get toOrderStatusEnum => OrderStatusEnum.fromCode(this);
}
...
extension OrderStatusExtension on OrderStatusEnum {
  ...
  bool get isPlaced => statusEnum == OrderStatusEnum.placed;
  ...
  Color get color {
    return switch (this) {
      ...
      OrderStatusEnum.placed => ColorConstants.orange,
