...
class LocationHelper {
  ...
  Stream<Position> getPositionStream({LocationAccuracy accuracy = LocationAccuracy.high, int distanceFilter = 10, Duration? intervalDuration}) {
  ...
  String getSubAddress(Placemark placemark) {
    print("getSubAddress==>>>> ${placemark.toJson()}");
  ...
  Future<void> _showDialog(
    ...
    showConfirmationDialog(
      ...
      subtitleStyle: context.textTheme.labelLarge?.copyWith(color: ColorConstants.grayColor11, fontSize: FontConstants.font_14.scaledFont(context)),
