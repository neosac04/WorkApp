import 'package:core/core/api_configuration/api_config_service.dart' show ApiConfigService;
...
class ModuleApiService {
  ...
  ApiService getApiService(String moduleName) {
    var baseUrl = _apiConfigService.getBaseUrl(moduleName);
  ...
  ApiService get eshopApiService => getApiService('ecom');
  ...
  ApiService get travelApiService => getApiService('flight');

  ApiService get hotelApiService => getApiService("hotel");

  ApiService get promoApiService => getApiService('promotions');

  ApiService get maidServicesApiService => getApiService('maid-services');

  ApiService get customerSupportApiService => getApiService('customer-support');

  ApiService get commonApiService => getApiService('common');

  ApiService get almatarApiService => getApiService('travel-almatar');

  /// Get default API service (uses first configured URL or default)
  ApiService get defaultApiService {
    final baseUrl = _apiConfigService.isConfigured ? _apiConfigService.defaultBaseUrl : "";
    return ApiService(_dio, baseUrl: baseUrl);
  }
}
