...
import 'package:core/common_widgets/common_view.dart' show CommonView;
...
mixin BaseScreenUiFun<T extends Enum, S extends BaseState<T>> {
  ...
  Widget buildFullVerticalList<ItemType>({
    ...
    final mustDisableScrolling = shrinkWrap || physics is NeverScrollableScrollPhysics;
    ...
    if (isLoading) {
      ...
      content = Skeletonizer(
        ...
        child: ListView.separated(
          padding: padding,
          physics: mustDisableScrolling ? const NeverScrollableScrollPhysics() : physics,
