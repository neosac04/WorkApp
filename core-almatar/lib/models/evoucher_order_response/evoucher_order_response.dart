...
@freezed
abstract class EVoucherOrderResponse with _$EVoucherOrderResponse {
  ...
  factory EVoucherOrderResponse.fromJson(Map<String, dynamic> json) =>
      _$EVoucherOrderResponseFromJson(json);
}
