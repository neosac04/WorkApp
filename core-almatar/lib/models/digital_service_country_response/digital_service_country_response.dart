...
@freezed
abstract class DigitalServiceCountryResponse
    with _$DigitalServiceCountryResponse {
  ...
  factory DigitalServiceCountryResponse.fromJson(Map<String, dynamic> json) =>
      _$DigitalServiceCountryResponseFromJson(json);
}
