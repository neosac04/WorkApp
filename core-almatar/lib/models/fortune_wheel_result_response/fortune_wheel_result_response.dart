...
abstract class FortuneWheelResultResponse with _$FortuneWheelResultResponse {
  ...
  factory FortuneWheelResultResponse.fromJson(Map<String, dynamic> json) =>
      _$FortuneWheelResultResponseFromJson(json);
}

@freezed
abstract class SpinResultSegment with _$SpinResultSegment {
  ...
  factory SpinResultSegment.fromJson(Map<String, dynamic> json) =>
      _$SpinResultSegmentFromJson(json);
}
