...
ESimOrderDetailResponse eSimOrderDetailResponseFromJson(String str) =>
    ESimOrderDetailResponse.fromJson(json.decode(str));

String eSimOrderDetailResponseToJson(ESimOrderDetailResponse data) =>
    json.encode(data.toJson());

@freezed
abstract class ESimOrderDetailResponse with _$ESimOrderDetailResponse {
  ...
  factory ESimOrderDetailResponse.fromJson(Map<String, dynamic> json) =>
      _$ESimOrderDetailResponseFromJson(json);
}
