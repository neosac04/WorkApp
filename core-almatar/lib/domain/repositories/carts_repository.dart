...
abstract class CartsRepository {
  ...
  Future<Either<String, CommonResponse<InitiateTamaraPayment>>> doInitiateTamaraPayment(Map<String, dynamic> params);
  ...
  Future<Either<String, CommonResponse>> deleteCart(Map<String, dynamic> params);
}
