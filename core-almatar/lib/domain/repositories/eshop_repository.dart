...
abstract class EshopRepository {
  ...
  Future<Either<String, CommonResponse<List<DealsResponseModel>>>> getDeals();

  Future<Either<String, CommonResponse<DealsResponseModel>>> getDealProductList(int dealId,Map<String, dynamic> params);

  Future<Either<String, CommonResponse<List<ReturnReasonsResponse>>>> getReturnReasons();
}
