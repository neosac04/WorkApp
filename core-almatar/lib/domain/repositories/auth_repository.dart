...
abstract class AuthRepository {
  ...
  Future<Either<String, CommonResponse<dynamic>>> sendOtp(Map<String, dynamic> params);

  Future<Either<String, CommonResponse<UserModel>>> doLogin(Map<String, String> params);

  Future<Either<String, CommonResponse>> doLogout(Map<String, String> params);

  Future<Either<String, CommonResponse>> doDeleteAccount();

  Future<Either<String, CommonResponse<RefreshTokenResponse>>> refreshToken(Map<String, String> params);
  ...
  Future<Either<String, CommonResponse<ReferralProgressModel>>> referralMessage();

  Future<Either<String, CommonResponse<CartCountModel>>> getCartCount(Map<String, dynamic> params);
}
