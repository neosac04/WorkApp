...
abstract class GroceryRepository {
  ...
  Future<Either<String, CommonResponse<List<GrocerySubCategoryResponse>>>> groceryProductList(Map<String, dynamic> params);
  ...
  Future<Either<String, GroceryOrdersTrackingResponse>> groceryOrderTracking(String fullUrl,String token);
