...
abstract class FoodRepository {
  ...
  Future<Either<String, FoodOrderTrackingResponse>> foodOrderTracking(String fullUrl, List<String> headersList);
  Future<Either<String, CommonResponse<FoodOrderInvoiceResponse>>> foodDeliveryOrdersInvoice(int orderId);
}
