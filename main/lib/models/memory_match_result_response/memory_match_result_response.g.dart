...
_$MemoryMatchResultResponseImpl _$$MemoryMatchResultResponseImplFromJson(
...
Map<String, dynamic> _$$MemoryMatchResultResponseImplToJson(
        _$MemoryMatchResultResponseImpl instance) =>
    <String, dynamic>{
...
_$MemoryMatchSegmentImpl _$$MemoryMatchSegmentImplFromJson(
        Map<String, dynamic> json) =>
    _$MemoryMatchSegmentImpl(
...
Map<String, dynamic> _$$MemoryMatchSegmentImplToJson(
        _$MemoryMatchSegmentImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
