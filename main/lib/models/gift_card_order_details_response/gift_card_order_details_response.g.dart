...
_GiftCardOrderDetailsResponse _$GiftCardOrderDetailsResponseFromJson(
...
Map<String, dynamic> _$GiftCardOrderDetailsResponseToJson(
  _GiftCardOrderDetailsResponse instance,
) => <String, dynamic>{
  'id': instance.id,
