...
_ESimProductsResponse _$ESimProductsResponseFromJson(
...
Map<String, dynamic> _$ESimProductsResponseToJson(
  _ESimProductsResponse instance,
) => <String, dynamic>{
  'id': instance.id,
...
_RoamingCountry _$RoamingCountryFromJson(Map<String, dynamic> json) =>
    _RoamingCountry(
      countryIso: json['country_iso'] as String?,
      countryName: json['country_name'] as String?,
      countryImage: json['country_image'] as String?,
...
Map<String, dynamic> _$RoamingCountryToJson(_RoamingCountry instance) =>
    <String, dynamic>{
      'country_iso': instance.countryIso,
      'country_name': instance.countryName,
      'country_image': instance.countryImage,
