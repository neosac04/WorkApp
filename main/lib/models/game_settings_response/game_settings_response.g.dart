...
_GameSettingsResponse _$GameSettingsResponseFromJson(
...
Map<String, dynamic> _$GameSettingsResponseToJson(
  _GameSettingsResponse instance,
) => <String, dynamic>{'fortune_wheel': instance.fortuneWheel};

_FortuneWheelConfig _$FortuneWheelConfigFromJson(Map<String, dynamic> json) =>
    _FortuneWheelConfig(
      ...
      orderSegments: GameSetting.fromJson(
        json['order_segments'] as Map<String, dynamic>,
      ),
...
Map<String, dynamic> _$FortuneWheelConfigToJson(_FortuneWheelConfig instance) =>
    <String, dynamic>{
...
_GameSetting _$GameSettingFromJson(Map<String, dynamic> json) => _GameSetting(
  value: json['value'],
  dataType: json['data_type'] as String?,
  description: json['description'] as String?,
);

Map<String, dynamic> _$GameSettingToJson(_GameSetting instance) =>
    <String, dynamic>{
