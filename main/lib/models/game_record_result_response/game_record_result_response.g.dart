...
_GameRecordResultResponse _$GameRecordResultResponseFromJson(
  ...
  walletBalance: json['wallet_balance'] == null
      ? null
      : WalletBalance.fromJson(json['wallet_balance'] as Map<String, dynamic>),
);

Map<String, dynamic> _$GameRecordResultResponseToJson(
  _GameRecordResultResponse instance,
) => <String, dynamic>{
...
_Spins _$SpinsFromJson(Map<String, dynamic> json) => _Spins(
...
Map<String, dynamic> _$SpinsToJson(_Spins instance) => <String, dynamic>{
