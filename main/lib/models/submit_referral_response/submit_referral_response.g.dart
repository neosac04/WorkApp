...
_$SubmitReferralDataImpl _$$SubmitReferralDataImplFromJson(
...
Map<String, dynamic> _$$SubmitReferralDataImplToJson(
        _$SubmitReferralDataImpl instance) =>
    <String, dynamic>{
...
_$GamificationResponseImpl _$$GamificationResponseImplFromJson(
        Map<String, dynamic> json) =>
    _$GamificationResponseImpl(
...
Map<String, dynamic> _$$GamificationResponseImplToJson(
        _$GamificationResponseImpl instance) =>
    <String, dynamic>{
...
_$ReferralDetailsImpl _$$ReferralDetailsImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$ReferralDetailsImplToJson(
        _$ReferralDetailsImpl instance) =>
    <String, dynamic>{
