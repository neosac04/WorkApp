...
_$GroceryCartResponseImpl _$$GroceryCartResponseImplFromJson(
...
Map<String, dynamic> _$$GroceryCartResponseImplToJson(
        _$GroceryCartResponseImpl instance) =>
    <String, dynamic>{
...
_$GroceryCartSummaryImpl _$$GroceryCartSummaryImplFromJson(
        Map<String, dynamic> json) =>
    _$GroceryCartSummaryImpl(
...
Map<String, dynamic> _$$GroceryCartSummaryImplToJson(
        _$GroceryCartSummaryImpl instance) =>
    <String, dynamic>{
