...
_GroceryCheckoutResponse _$GroceryCheckoutResponseFromJson(
...
Map<String, dynamic> _$GroceryCheckoutResponseToJson(
  _GroceryCheckoutResponse instance,
) => <String, dynamic>{'cart': instance.groceryCart};

_GroceryCartData _$GroceryCartDataFromJson(Map<String, dynamic> json) =>
    _GroceryCartData(
...
Map<String, dynamic> _$GroceryCartDataToJson(_GroceryCartData instance) =>
    <String, dynamic>{
