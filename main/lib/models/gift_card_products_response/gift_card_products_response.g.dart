...
_$GiftCardProductsResponseImpl _$$GiftCardProductsResponseImplFromJson(
        Map<String, dynamic> json) =>
    _$GiftCardProductsResponseImpl(
...
Map<String, dynamic> _$$GiftCardProductsResponseImplToJson(
        _$GiftCardProductsResponseImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
