...
_$ESimOrderDetailResponseImpl _$$ESimOrderDetailResponseImplFromJson(
...
Map<String, dynamic> _$$ESimOrderDetailResponseImplToJson(
        _$ESimOrderDetailResponseImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
