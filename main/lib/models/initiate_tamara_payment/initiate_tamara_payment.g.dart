...
_InitiateTamaraPayment _$InitiateTamaraPaymentFromJson(
  ...
  transactionHistoryId: (json['transaction_history_id'] as num?)?.toInt() ?? 0,
  walletDeduction: (json['wallet_deduction'] as num?)?.toDouble() ?? 0.0,
  payableAmount: (json['payable_amount'] as num?)?.toDouble() ?? 0.0,
);

Map<String, dynamic> _$InitiateTamaraPaymentToJson(
  _InitiateTamaraPayment instance,
) => <String, dynamic>{
